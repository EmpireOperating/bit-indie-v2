...
export const DeveloperProfileScalarFieldEnum = {
    userId: 'userId',
    payoutLnAddress: 'payoutLnAddress',
    createdAt: 'createdAt',
    updatedAt: 'updatedAt'
};
...
export const BuildAssetScalarFieldEnum = {
    id: 'id',
    releaseId: 'releaseId',
    objectKey: 'objectKey',
    sha256: 'sha256',
...
export const BuildUploadIntentScalarFieldEnum = {
    id: 'id',
    releaseId: 'releaseId',
    objectKey: 'objectKey',
    contentType: 'contentType',
...
export const PurchaseScalarFieldEnum = {
    ...
    guestReceiptCode: 'guestReceiptCode',
    gameId: 'gameId',
...
export const PayoutScalarFieldEnum = {
    ...
    purchaseId: 'purchaseId',
    developerUserId: 'developerUserId',
    destinationLnAddress: 'destinationLnAddress',
    amountMsat: 'amountMsat',
    status: 'status',
